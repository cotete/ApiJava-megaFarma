...
public class ConnectionFactory {
    ...
    public static ConnectionFactory getInstance() {
        ...
        try{
            ...
            file.close();
            if (instance==null){
                instance = new ConnectionFactory(url,username,pass,driver);
            }
            return instance;
    ...
    public Connection getConexao() {
        try{
            ...
            if (this.getUser() == null|| this.getUser().isEmpty()) {
                throw new SQLException("Nome de usuário nulo ou em branco");
            }
            Class.forName(this.getDriver());
            this.conexao = DriverManager.getConnection(this.getUrl(),this.user,this.getPass());
